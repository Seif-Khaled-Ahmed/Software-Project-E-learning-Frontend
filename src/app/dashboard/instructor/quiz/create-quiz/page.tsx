...
const CreateQuiz: React.FC = () => {
  ...
  const [moduleId, setModuleId] = useState(""); // Module ID input
  ...
  const handleSubmitQuiz = async () => {
    if (!moduleId || !quizTitle || questions.length === 0) {
      alert("Please provide a module ID, title, and at least one question.");
      return;
    }
